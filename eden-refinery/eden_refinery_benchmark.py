#!/usr/bin/env python3
"""EDEN Refinery LLM benchmark using Azure OpenAI as the provider.

Calls Azure OpenAI Responses API, applies a deterministic EDEN Refinery envelope to
...
OUT = Path(os.getenv("EDEN_OUTPUT_DIR", "eden-refinery/results"))
